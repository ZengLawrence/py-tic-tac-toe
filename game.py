...
class Game:
    ...
    def start(self, run, done):
        """
            Starts game. Execute run function repeatedly while the game is running, and done function when the game ends.

            Both run and done function takes game instance as input.
        """
        while self.running():
            run(self)
        done(self)
